...
**Last updated**: 2026-07-02T02:08:34+09:00
...
# Option B: Build locally (default: WAV format)
docker build -t asterisk-ja .

# Option C: Build with custom sound format (gsm, ulaw, alaw, g722, sln16)
docker build --build-arg SOUND_FORMAT=gsm -t asterisk-ja .
```
...
- **Sound Files**: Japanese language prompts pre-installed (WAV format by default)
  - Available formats: wav, gsm, ulaw, alaw, g722, sln16
  - Format can be selected at build time with `--build-arg SOUND_FORMAT=<format>`
